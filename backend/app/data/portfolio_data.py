...
portfolio_data = {
    "about": {
        "journey": "I'm a passionate AI/ML developer with a strong specialization in Generative AI and Large Language Models, honed through my Master's in Computer Science and hands-on internship experience. My background in building intelligent chatbots, voice assistants, and video insight systems allows me to create scalable, real-time AI solutions that enhance user engagement and efficiency.",
        "what_i_do": [
        ...
        "belief": "I believe in the power of context-aware interactions and data-driven pipelines. Every embedding, retriever, and API integration serves a purpose in delivering accurate and meaningful AI experiences."
    },
    "skills": [
    ...
    "education": {
        "masters": "M.Sc. (Computer Science) - K.K. Wagh College - CGPA: 7.91",
        "bachelors": "B.Sc. (Computer Science) - K.K. Wagh College - CGPA: 8.27"
    }
}